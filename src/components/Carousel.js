      ...
      <div className="container-fluid">
        <div className="position-relative">
          <div className="carousel-inner row flex-nowrap align-items-center">
            <div
              className="arrow-carousel carousel-left"
              ...
              <div className="carousel-item-custom " key={index}>
                ...
                <div className="carousel-info">
                  ...
                  <div className="time-info">
                    ...
                    <span className="tag light free green-tag">
                      {el.isAcceptingDelivery ? "freeDelivery" : "freePickup"}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div
              className="arrow-carousel carousel-right"
