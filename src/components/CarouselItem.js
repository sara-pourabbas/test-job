        ...
        <div className="middle-contain-head">
          <div className="middle-contain-head-menu">
            ...
            <div className="type-select">
              <div
                className={`marker ${
                  this.state.typeMarker === "delivery"
                    ? "marker-delivery"
                    : "marker-pickup"
                } `}
              />
              <div className="type-item" onClick={this.deliveryMarker}>
                Delivery
              </div>
              <span className="sep mx-2">Or</span>
              <div className="type-item" onClick={this.pickupMarker}>
                Pickup
              </div>
            </div>
        ...
        <div className="carousel-content">
          <div className="items-contain">
              ...
              <div className="gift-body">
                ...
                <div className="desc text-justify">
                  <p className="mb-0">
                    ...
                    reward and incentive programs that can meet your
                    restaurant’s goals.
                  </p>
                  <p>
            ...
            <div className="ready py-4">
              ...
              <div className="title-ready-sub mt-2">
